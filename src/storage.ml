...
let get_token_exn : get_token_exn = fun () -> get_token () |> Promise.map Option.getExn
...
let get_rating_data_exn : get_rating_data_exn = fun id -> get_rating_data id |> Promise.map Option.getExn
