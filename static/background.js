...
var Tabs = /* module */[/* query_p */query_p];
...
function make_request(url, data) {
  return fetch(url, RequestInit[/* make */0](/* Some */[/* Post */2], /* Some */[/* array */[/* tuple */[
                          "content-type",
                          "application/json"
                        ]]], /* Some */[JSON.stringify(data)], /* None */0, /* None */0, /* Some */[/* CORS */3], /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* () */0)).then((function (prim) {
                return prim.json();
              }));
}
...
// Generated by BUCKLESCRIPT VERSION 1.8.2, PLEASE EDIT WITH CARE
function unsafely_unwrap_option(param) {
  if (param) {
    return param[0];
  } else {
    return failwith("No result");
  }
}

function set_rating_to_storage(url, ratings, storage_value) {
  var opt = storage_value["ratings"];
  var original_ratings = opt !== undefined ? unsafely_unwrap_option(decodeObject(opt)) : { };
  var ratings$prime = fromArray(append(/* array */[/* tuple */[
              url,
              ratings
            ]], entries(original_ratings)));
  return _1(Storage[/* Local */1][/* set_p */1], fromArray(/* array */[/* tuple */[
                    "ratings",
                    ratings$prime
                  ]]));
}
...
chrome.tabs.onUpdated.addListener((function (tab_id, change_info, tab) {
        ...
        if (match === "complete") {
          ...
          if (url.startsWith("http")) {
            fetch_rating(url).then((function (response) {
                    var response_dict = unsafely_unwrap_option(decodeObject(response));
                    return Promise.resolve(_1(Storage[/* Local */1][/* get_p */0], "ratings").then((function (ratings) {
                                        return Promise.resolve(set_rating_to_storage(url, response_dict, ratings));
                                      })).then((function () {
...
chrome.runtime.onMessage.addListener((function (msg, _) {
        ...
        if (typeof match === "number" && match === 2) {
          _1(Storage[/* Local */1][/* get_p */0], "ratings").then((function (storage_value) {
                    return Tabs[/* query_p */0]({
                                  active: true,
                                  currentWindow: true
                                }).then((function (tabs) {
                                  var tab = caml_array_get(tabs, 0);
                                  var ratings = unsafely_unwrap_option(decodeObject(unsafely_unwrap_option(undefined_to_opt(storage_value["ratings"]))));
                                  return Promise.resolve(unsafely_unwrap_option(undefined_to_opt(ratings[tab.url])));
                                }));
