...
// Generated by BUCKLESCRIPT VERSION 1.8.2, PLEASE EDIT WITH CARE
function get_ratings_from_storage() {
  return _1(Storage[/* Local */1][/* get */0], "ratings").then((function (storage_value) {
                return Promise.resolve(decodeObject(storage_value["ratings"]));
              }));
}

function get_ratings_from_storage_exn() {
  return get_ratings_from_storage(/* () */0).then((function (ratings) {
                return Promise.resolve(getExn(ratings));
              }));
}

function append_rating_to_storage(url, ratings) {
  return get_ratings_from_storage(/* () */0).then((function (opt) {
                  if (opt) {
...
chrome.runtime.onMessage.addListener((function (msg, _) {
        ...
        if (match !== 3) {
          ...
          console.log("Received FetchRating");
          get_ratings_from_storage_exn(/* () */0).then((function (ratings) {
                    return Tabs[/* query */0]({
                                  active: true,
                                  currentWindow: true
                                }).then((function (tabs) {
